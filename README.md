...
**Latest published release:** [v0.14.0](https://github.com/GalaxyRuler/Verbatim/releases/tag/v0.14.0) (2026-07-20)

| Platform            | Direct downloads                                                                                                                                                                                                      |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Windows x64         | [setup.exe](https://github.com/GalaxyRuler/Verbatim/releases/download/v0.14.0/Verbatim_0.14.0_x64-setup.exe) · [MSI](https://github.com/GalaxyRuler/Verbatim/releases/download/v0.14.0/Verbatim_0.14.0_x64_en-US.msi) |
| macOS Apple Silicon | [DMG](https://github.com/GalaxyRuler/Verbatim/releases/download/v0.14.0/Verbatim_0.14.0_aarch64.dmg)                                                                                                                  |
| Ubuntu x64          | [DEB](https://github.com/GalaxyRuler/Verbatim/releases/download/v0.14.0/Verbatim_0.14.0_amd64.deb)                                                                                                                    |
