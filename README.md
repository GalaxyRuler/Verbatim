...
- Medium (492 MB): `https://galaxyruler.space/verbatim-assets/whisper-medium-q4_1.bin` (custom q4_1 quantization originally packaged by the upstream Handy project; not available on Hugging Face)
...
- V2 (473 MB): `https://galaxyruler.space/verbatim-assets/parakeet-v2-int8.tar.gz`
- V3 (478 MB): `https://galaxyruler.space/verbatim-assets/parakeet-v3-int8.tar.gz`
