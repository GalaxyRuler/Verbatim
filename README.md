...
**Latest published release:** [v0.14.1](https://github.com/GalaxyRuler/Verbatim/releases/tag/v0.14.1) (2026-08-05)

| Platform            | Direct downloads                                                                                                                                                                                                      |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Windows x64         | [setup.exe](https://github.com/GalaxyRuler/Verbatim/releases/download/v0.14.1/Verbatim_0.14.1_x64-setup.exe) · [MSI](https://github.com/GalaxyRuler/Verbatim/releases/download/v0.14.1/Verbatim_0.14.1_x64_en-US.msi) |
| macOS Apple Silicon | [DMG](https://github.com/GalaxyRuler/Verbatim/releases/download/v0.14.1/Verbatim_0.14.1_aarch64.dmg)                                                                                                                  |
| Ubuntu x64          | [DEB](https://github.com/GalaxyRuler/Verbatim/releases/download/v0.14.1/Verbatim_0.14.1_amd64.deb)                                                                                                                    |
