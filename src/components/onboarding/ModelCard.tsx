...
const ModelCard: React.FC<ModelCardProps> = ({
  ...
  const baseClasses =
    "flex flex-col rounded-lg px-4 py-3 gap-2 text-left transition-all duration-200";
  ...
  const getInteractiveClasses = () => {
    ...
    return "cursor-pointer hover:border-accent/50 hover:bg-accent/5";
  };
      ...
      <div className="flex justify-between items-center w-full">
        <div className="flex flex-col items-start flex-1 min-w-0">
          <div className="flex items-center gap-3 flex-wrap">
            <h3 className="text-base font-semibold text-text transition-colors">
              {displayName}
            </h3>
      ...
      <div className="flex items-center gap-3 w-full -mb-0.5 mt-0.5 h-5">
        ...
        {onDelete && (status === "available" || status === "active") && (
          <Button
            ...
            className="flex items-center gap-1.5 ms-auto text-accent/85 hover:text-accent"
          >
