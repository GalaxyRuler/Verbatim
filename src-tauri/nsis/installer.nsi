; Custom NSIS template for Verbatim with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Verbatim for portable
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Verbatim Portable Mode"
    FileClose $0
