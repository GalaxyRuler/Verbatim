...
//!
//! `verbatim-keys` provides a simple way to register and listen for global keyboard
...
//!
//! ```no_run
//! use verbatim_keys::{HotkeyManager, Hotkey, Modifiers, Key};
//!
//! fn main() -> verbatim_keys::Result<()> {
...
//!
//! ```no_run
//! use verbatim_keys::KeyboardListener;
//!
...
//! # #[cfg(target_os = "macos")]
//! # fn main() -> verbatim_keys::Result<()> {
//! use verbatim_keys::{check_accessibility, open_accessibility_settings};
//!
