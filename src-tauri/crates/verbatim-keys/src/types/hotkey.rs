...
impl Hotkey {
    ...
    /// # Examples
    /// ```
    /// use verbatim_keys::{Hotkey, Modifiers, Key};
    ///
    ...
    /// Format hotkey using Verbatim-compatible key names (lowercase with full modifier names)
    ///
    ...
    pub fn to_verbatim_string(&self) -> String {
        #[cfg(target_os = "macos")]
        fn mod_names(
            mods: Modifiers,
            left: Modifiers,
